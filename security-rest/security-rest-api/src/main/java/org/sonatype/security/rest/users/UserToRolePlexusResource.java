    ...
    extends AbstractUserPlexusResource
{
    ...
    @Override
    @PUT
    @ResourceMethodSignature( input = UserToRoleResourceRequest.class, pathParams = { @PathParam( "sourceId"), @PathParam( "userId") } )
    ...
    @Override
    @GET
    @ResourceMethodSignature( output = UserToRoleResourceRequest.class, pathParams = { @PathParam( "sourceId"), @PathParam( "userId") } )
